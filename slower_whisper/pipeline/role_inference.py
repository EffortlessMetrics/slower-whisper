...
AGENT_TRIGGERS: list[tuple[re.Pattern[str], float, str]] = [
    ...
    (
        re.compile(r"\blet me look that up\b", re.IGNORECASE),
        0.5,
        "service phrase: 'let me look that up'",
    ),
    (re.compile(r"\blet me verify\b", re.IGNORECASE), 0.5, "service phrase: 'let me verify'"),
    (
        re.compile(r"\bI can help you with that\b", re.IGNORECASE),
        0.7,
        "service phrase: 'I can help'",
    ),
    (re.compile(r"\bI'd be happy to\b", re.IGNORECASE), 0.4, "service phrase: 'I'd be happy to'"),
    (
        re.compile(r"\bfor security purposes\b", re.IGNORECASE),
        0.6,
        "verification: 'for security purposes'",
    ),
    (
        re.compile(r"\bcan I have your account\b", re.IGNORECASE),
        0.7,
        "verification: request account",
    ),
    ...
    (
        re.compile(r"\bwill there be anything else\b", re.IGNORECASE),
        0.6,
...
FACILITATOR_TRIGGERS: list[tuple[re.Pattern[str], float, str]] = [
    ...
    (
        re.compile(r"\bwould anyone like to\b", re.IGNORECASE),
        0.6,
        "facilitation: 'would anyone like to'",
    ),
