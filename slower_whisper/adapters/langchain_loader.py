"""LangChain loader for slower-whisper transcripts.
...
from slower_whisper.pipeline.chunking import ChunkingConfig, build_chunks
from slower_whisper.pipeline.models import Chunk, Transcript


@dataclass
class SlowerWhisperLoader:
    path: str | Path
