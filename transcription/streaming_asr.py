...
class StreamingASRAdapter:
    ...
    def _detect_speech_frames(self, audio: np.ndarray, frame_size_ms: int = 30) -> list[bool]:
        ...
        # Vectorized RMS energy calculation: avoid slow Python loops by reshaping the entire
        # array to frame boundaries and computing the energy for all frames simultaneously.
