...
def format_doctor_report(report: DoctorReport, use_color: bool = True) -> str:
    ...
    if use_color and Colors.should_use_color():
        symbols = {
            CheckStatus.PASS: Colors.green(Symbols.check()),
            CheckStatus.WARN: Colors.yellow(Symbols.warn()),
            CheckStatus.FAIL: Colors.red(Symbols.cross()),
            CheckStatus.SKIP: Colors.dim(Symbols.info()),
        }
    else:
        symbols = {
            CheckStatus.PASS: Symbols.CHECK_ASCII,
            CheckStatus.WARN: Symbols.WARN_ASCII,
            CheckStatus.FAIL: Symbols.CROSS_ASCII,
            CheckStatus.SKIP: Symbols.INFO_ASCII,
        }
