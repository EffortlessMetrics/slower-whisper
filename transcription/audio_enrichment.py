...
def _enrich_segment_with_extractor(
    extractor: AudioSegmentExtractor | None,
    wav_path: Path,
    segment: Segment,
    ...
    """
    Internal helper that reuses an existing AudioSegmentExtractor.
    ...
    try:
        # Use provided extractor or create new one as fallback
