...
class KeywordSemanticAnnotator:
    ...
    def annotate(self, transcript: Transcript) -> Transcript:
        ...
        for segment in transcript.segments:
            ...
            # Optimization: fast-path literal string inclusion check `kw_lower in text_lower`
            # before evaluating the expensive regex search. This avoids evaluating the regex when
            # the keyword string isn't in the text.
